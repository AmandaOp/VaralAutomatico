...
F:G$ini_glcd$0$0({2}DF,SV:S),C,0,0,0,0,0
...
T:Fglcd$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Fglcd$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$conta_caractere$0$0({1}SC:U),E,0,0
S:Lglcd.esc_glcd$byte$1$29({1}SC:U),R,0,0,[r7]
S:Lglcd.ini_glcd$cs$1$31({1}SC:U),R,0,0,[r7]
S:Lglcd.conf_Y$y$1$33({1}SC:U),R,0,0,[r7]
S:Lglcd.conf_pag$pag$1$35({1}SC:U),R,0,0,[r7]
S:Lglcd.limpa_glcd$pag$1$38({1}SC:U),R,0,0,[r7]
S:Lglcd.limpa_glcd$y$1$38({1}SC:U),R,0,0,[r6]
S:Lglcd.escreve_caractere$c$1$44({1}SC:U),R,0,0,[r7]
S:Lglcd.escreve_caractere$linha$1$45({1}SC:U),R,0,0,[r7]
S:Lglcd.putchar$c$1$46({1}SC:U),R,0,0,[r7]
S:Lglcd.le_glcd$cd$1$27({1}SB0$1:U),H,0,0
S:Lglcd.le_glcd$cs$1$27({1}SB0$1:U),H,0,0
S:Lglcd.esc_glcd$cd$1$29({1}SB0$1:U),H,0,0
S:Lglcd.esc_glcd$cs$1$29({1}SB0$1:U),H,0,0
S:Lglcd.ini_glcd$sloc0$1$0({1}SB0$1:U),H,0,0
S:Lglcd.conf_Y$cs$1$33({1}SB0$1:U),H,0,0
S:Lglcd.conf_pag$cs$1$35({1}SB0$1:U),H,0,0
S:Lglcd.limpa_glcd$cs$1$37({1}SB0$1:U),H,0,0
S:Lglcd.escreve_caractere$cs$1$44({1}SB0$1:U),H,0,0
S:Lglcd.putchar$lado$1$47({1}SB0$1:U),H,0,0
...
S:G$ini_glcd$0$0({2}DF,SV:S),C,0,0
